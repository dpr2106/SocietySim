...
1. RELEVANCE FILTERING: Evaluate if the news is actually relevant to the character's archetype. 
   ...
   - If the news IS relevant, give a deep, thoughtful reaction.
2. LENGTH: Each quote MUST be 2 to 3 full sentences. Do NOT give short 5-word answers.
3. PERSONALITY: Match the character's archetype perfectly.
...
CRITICAL RULES:
1. RELEVANCE: Only care about the news if it fits the archetype. (Soldiers ignore sports, Politicians ignore fashion). If irrelevant, the character should state they don't care or are busy with their normal life.
2. LENGTH: Each quote MUST be 2 to 3 full sentences. Provide deep, immersive thoughts.
3. TOPIC: Reference the specific topic from the headline if relevant.
